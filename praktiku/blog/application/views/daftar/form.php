              ...
              <div class="card">
                ...
                <?php echo form_open("daftar/save") ?>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-8">
                      <input id="tanggal_daftar" name="tanggal_daftar" placeholder="Masukkan tanggal_daftar" type="date" class="form-control" spellcheck="false" data-ms-editor="true">
                    </div>
                  </div>
                  <div class="form-group row">
                    <label for="alasan" class="col-4 col-form-label">Alasan</label> 
                    <div class="col-8">
                      <input id="alasan" name="alasan" placeholder="Alasan ingin mengikuti event ini" type="text" class="form-control" spellcheck="false" data-ms-editor="true">
                    </div>
                  </div>
                  <div class="form-group row">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-8">
                      <select id="kegiatan_id" name="kegiatan_id" class="form-control">
                        <?php
                          include "config.php";
                          $result = mysqli_query($connect, "SELECT * FROM kegiatan");
                          while ($row = mysqli_fetch_array($result)) 
                        { ?>
                          <option value="<?php echo $row[0]?>">
                        <?php echo $row[1]?>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-8">
                      <select id="kategori_peserta_id" name="kategori_peserta_id" class="form-control">
                        <?php
                          include "config.php";
                          $result = mysqli_query($connect, "SELECT * FROM kategoripeserta");
                          while ($row = mysqli_fetch_array($result)) 
                        { ?>
                          <option value="<?php echo $row[0]?>">
                        <?php echo $row[1]?>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-8">
                      <input id="nosertifikat" name="nosertifikat" type="text" class="form-control" spellcheck="false" data-ms-editor="true">
                    </div>
                  </div> 
                  <div class="form-group row">
                    <div class="offset-4 col-8">
                      <button name="submit" type="submit" class="btn btn-primary btn-sm">Submit</button>
                    </div>
                  </div>
                <?php echo form_close() ?>
